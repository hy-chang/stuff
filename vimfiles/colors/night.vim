...
" Search
hi IncSearch    gui=UNDERLINE,NONE guifg=#f0f0f8 guibg=#d000d0
hi Search       gui=NONE guifg=#ffd0ff guibg=#c000c0

" Messages
hi ErrorMsg     gui=NONE guifg=#ffffff guibg=#f00080
hi WarningMsg   gui=NONE guifg=#ffffff guibg=#f00080
hi ModeMsg      gui=NONE guifg=#00e0ff guibg=NONE
hi MoreMsg      gui=NONE guifg=#00ffdd guibg=NONE
hi Question     gui=NONE guifg=#d0d050 guibg=NONE
...
" Fold
hi Folded       gui=NONE guifg=#e8e8ff guibg=#7070c0
...
hi NonText      gui=NONE guifg=#8040ff guibg=#383848
hi SpecialKey   gui=NONE guifg=#60a0ff guibg=NONE
hi Title        gui=NONE guifg=#f0f0f8 guibg=#9000a0
hi Visual       gui=NONE guifg=#ffffff guibg=#d09050

" Syntax group
hi Comment      gui=NONE guifg=#595977 guibg=NONE
hi Constant     gui=NONE guifg=#f0f0f8 guibg=#4830a0
hi Error        gui=NONE guifg=#ffffff guibg=#f00080
...
hi Statement    gui=NONE guifg=#00ccbb guibg=NONE
hi Todo         gui=NONE guifg=#ffe0c8 guibg=#c07038
hi Type         gui=NONE guifg=#bb99ff guibg=NONE
hi Underlined   gui=UNDERLINE,NONE guifg=#f0f0f8 guibg=NONE

" HTML
hi htmlLink                 gui=UNDERLINE,NONE
hi htmlNONE                 gui=NONE
hi htmlNONEItalic           gui=NONE,ITALIC
hi htmlNONEUnderline        gui=NONE,UNDERLINE
hi htmlNONEUnderlineItalic  gui=NONE,UNDERLINE,ITALIC
